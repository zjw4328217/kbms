    ...
    <div class="container _kbms">
        <div v-show="isTableShow">
            ...
            <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="title" label="标题" width="150" align="center" sortable>
                 ...
                 <el-table-column prop="publicState" label="发布状态" align="center" width="80">
                </el-table-column>
                 <el-table-column prop="depositoryBank" label="存管银行" align="center" width="150">
                </el-table-column>
                 <el-table-column prop="businessType" label="业务类型" align="center" width="150">
                </el-table-column>
                 <el-table-column prop="businessScene" label="业务场景" align="center" width="150">
                </el-table-column>
                 <el-table-column prop="keywords" label="关键字" align="center" width="100">
                      <template slot-scope="scope">
                        <p class="line-limit-length">{{scope.row.keywords|convertKeyWords}}</p>
                    </template>
                </el-table-column>
                <el-table-column prop="createTime" label="创建日期" align="center" :formatter="this.$common.timestampToTime" width="160" sortable>
                </el-table-column>
                <el-table-column prop="updateTime" label="更新日期" align="center" :formatter="this.$common.timestampToTime" width="160" sortable>
                </el-table-column>
                <el-table-column prop="creator" label="创建人" align="center" width="70">
                </el-table-column>
                <el-table-column prop="viewCount" label="浏览次数" align="center" width="80">
                </el-table-column>
                <el-table-column label="操作" fixed="right" min-width="260">
                    <template slot-scope="scope">
                        <span v-if="scope.row.publicState=='未发布'||scope.row.publicState==''">
                            <el-button size="mini" plain type="primary" @click="updatePublicState(scope.$index, scope.row,'已发布')">{{scope.row.publicState|convertPublic}}</el-button>
                        </span>
                        <span v-else>
                            <el-button size="mini" plain type="warning" @click="updatePublicState(scope.$index, scope.row,'未发布')">{{scope.row.publicState|convertPublic}}</el-button>
                        </span>
        ...
        <div class="_edit" v-show="isEditShow">
            <!-- 编辑弹框---start -->
                ...
                <el-form :label-position="labelPosition" :label-width="labelWidth" :rules="rulesEdit" :disabled="formEditDisabled" :inline="false" ref="formEdit" :model="formEdit" class="demo-form-inline">
                    ...
                    <el-form-item label="关键字" prop="keywords">
                        <el-tag
                            :key="tag"
                            v-for="tag in formEdit.keywords"
                            closable
                    ...
                    <el-form-item label="业务类型" prop="businessType">
                        <el-select v-model="formEdit.businessType" placeholder="存管银行">
                            <el-option label="业务类型一" value="业务类型一"></el-option>
                            <el-option label="业务类型二" value="业务类型二"></el-option>
                            <el-option label="业务类型三" value="业务类型三"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="业务场景" prop="businessScene">
                        <el-select v-model="formEdit.businessScene" placeholder="存管银行">
                            <el-option label="业务场景一" value="业务场景一"></el-option>
                            <el-option label="业务场景二" value="业务场景二"></el-option>
                            <el-option label="业务场景三" value="业务场景三"></el-option>
                        </el-select>
                    </el-form-item>
                </el-form>
...
export default {
    ...
    methods: {
        ...
        initCKEditor() {
         ...
         handleClose(tag) {
             if(!this.formEditDisabled){
                this.formEdit.keywords.splice(this.formEdit.keywords.indexOf(tag), 1);
             }
        },
        showInput() {
        ...
        handleInputConfirm() {
            ...
            let inputValue = this.inputValue;
                if (inputValue&&this.formEdit.keywords.indexOf(inputValue)==-1) {
                    this.formEdit.keywords.push(inputValue);
                }
