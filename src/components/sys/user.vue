    ...
    <div class="container _user">
        ...
        <el-form :label-position="labelPosition" :label-width="labelWidth" :inline="true" ref="formSearch" :model="formSearch" class="demo-form-inline">
            ...
            <el-form-item label="登录名" prop="loginName">
                <el-input v-model="formSearch.loginName" placeholder="登录名"></el-input>
            </el-form-item>
            ...
            <el-form-item label="手机号" prop="phone">
                <el-input type="number" v-model="formSearch.phone" placeholder="手机号"></el-input>
            </el-form-item>
            <el-form-item label="邮件" prop="email">
               <el-input v-model="formSearch.email" placeholder="邮件"></el-input>
            </el-form-item>
            <el-form-item label="岗位" prop="position">
                <el-input v-model="formSearch.position" placeholder="岗位"></el-input>
            </el-form-item>
            <el-form-item label="组织" prop="organization">
                <el-input v-model="formSearch.organization" placeholder="组织"></el-input>
            </el-form-item>
            <el-form-item label="账户状态" prop="state">
                <el-select v-model="formSearch.state" placeholder="账户状态">
                    <el-option label="启用" value="启动"></el-option>
        ...
        <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="email" label="邮件" align="center" width="150">
            </el-table-column>
            <el-table-column prop="position" label="岗位" align="center" width="100">
            </el-table-column>
            <el-table-column prop="organization" label="组织" align="center" width="100">
            </el-table-column>
        ...
        <el-dialog  :title="formEditTitle" :visible.sync="dialogEdittVisible" width="700px" @close="closeDialog('formEdit')">
            <el-form :label-position="labelPosition" :label-width="labelWidth" :rules="rulesEdit" :disabled="formEditDisabled" :inline="true" ref="formEdit" :model="formEdit" class="demo-form-inline">
                ...
                <el-form-item label="登录名" prop="loginName">
                    <el-input v-model="formEdit.loginName" placeholder="登录名"></el-input>
                </el-form-item>
               <el-form-item label="性别" prop="gender">
                 ...
                 <el-form-item label="账户状态" prop="state">
                    <el-select v-model="formEdit.state" placeholder="账户状态">
                        <el-option label="启用" value="启动"></el-option>
                        <el-option label="停用" value="停用"></el-option>
                    </el-select>
                </el-form-item>
                 <el-form-item label="手机号" prop="phone">
                    <el-input type="number" v-model="formEdit.phone" placeholder="手机号"></el-input>
                </el-form-item>
                <el-form-item label="邮件" prop="email">
                    <el-input v-model="formEdit.email" placeholder="邮件"></el-input>
                </el-form-item>
                <el-form-item label="岗位" prop="position">
                    <el-input v-model="formEdit.position" placeholder="岗位"></el-input>
                </el-form-item>
                <el-form-item label="组织" prop="organization">
                    <el-input v-model="formEdit.organization" placeholder="组织"></el-input>
                </el-form-item>
                 <el-form-item v-show="dialogType=='edit'" label="重置密码" prop="resetPwd">
                   <el-checkbox v-model="formEdit.resetPwd">{{formEdit.resetPwd==true?'选中':'未选中'}}</el-checkbox>
                </el-form-item>
...
export default {
        ...
        return {
            ...
            formEdit: { //表单编辑
             ...
             rulesEdit:  {
                ...
                state: [{ required: true, message: "请选择账户状态", trigger: "change" }],
    ...
    methods: {
        ...
        onDeleteMany() {
            ...
            this.$confirm('此操作将批量永久删除文件, 是否继续?', '提示', {
                    ...
                    type: 'warning'
                        ...
                        apis.userApi.deleteBatch({ids:ids})
                        .then((data)=>{
                            this.$common.isSuccess(data,()=>{
                                debugger;
                                this.onSearch();
        ...
        handleEdit(index, rowData) {
            //var user = "索引是:" + index + ",行内容是:" + JSON.stringify(rowData);
            ...
            this.$nextTick(()=>{
                ...
                this.formEditDisabled=false;
                this.formEdit= Object.assign({resetPwd:false}, rowData);
